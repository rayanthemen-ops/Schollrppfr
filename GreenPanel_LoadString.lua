-- 🟢 LOADING STRING DELTA - Panel Vert "nom sf"
-- Copie JUSTE CETTE LIGNE et colle dans Delta :
-- loadstring(game:GetService("HttpService"):GetAsync("https://raw.githubusercontent.com/rayanthemen-ops/Schollrppfr/main/GreenPanel.lua"))()

-- OU utilise ce code complet ci-dessous :
